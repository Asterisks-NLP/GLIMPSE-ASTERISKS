...
from transformers import AutoModel, AutoModelForSeq2SeqLM, AutoTokenizer, AutoModelForCausalLM
...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="gavin124/gpt2-finetuned-cnn-summarization-v2")
